...
- Timestamp: `2022-06-09 02:07`
- Build ID: `95784e2f-500b-405a-8f23-344425375a4f`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/95784e2f-500b-405a-8f23-344425375a4f.git
$ cd 95784e2f-500b-405a-8f23-344425375a4f
```
